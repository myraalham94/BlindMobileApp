...
public class Modul4Content : MonoBehaviour {
	...
	void Start () {
		...
		audiosource.time = PlayerPrefs.GetFloat ("Modul_4");//nak load audio yg dah save bila bukak je scene tu
	...
	public void ChooseBookmark(){
		...
		PlayerPrefs.SetFloat ("Modul_4", audiosource.time);//nak save/bookmark audio yg dah pause
	...
	public void ChooseReplay(){
		...
		SceneManager.LoadScene("Start Modul 4");
		PausePanel.SetActive (false);
