...
public class Modul3Content : MonoBehaviour {
	...
	void Start () {
		...
		audiosource.time = PlayerPrefs.GetFloat ("Modul_3");//nak load audio yg dah save bila bukak je scene tu
	...
	public void ChooseBookmark(){
		...
		PlayerPrefs.SetFloat ("Modul_3", audiosource.time);//nak save/bookmark audio yg dah pause
	...
	public void ChooseReplay(){
		...
		SceneManager.LoadScene("Start Modul 3");
		PausePanel.SetActive (false);
