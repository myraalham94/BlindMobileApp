...
public class ObjektifModul1 : MonoBehaviour {
	...
	void Start () {
		...
		audiosource.time = PlayerPrefs.GetFloat ("Objektif Modul 1");
	...
	public void chooseBookmark(){
		...
		PlayerPrefs.SetFloat ("Objektif Modul 1", audiosource.time);
	}

	public void chooseReplay(){

		PlayerPrefs.DeleteAll ();
		SceneManager.LoadScene ("Objektif Modul 1");
