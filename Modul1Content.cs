...
public class Modul1Content : MonoBehaviour {
	...
	void Start () {
		...
		audiosource.time = PlayerPrefs.GetFloat ("Modul_1");//nak load audio yg dah save bila bukak je scene tu
	...
	public void ChooseBookmark(){
		...
		PlayerPrefs.SetFloat ("Modul_1", audiosource.time);//nak save/bookmark audio yg dah pause
	...
	public void ChooseReplay(){
		...
		SceneManager.LoadScene("Start Modul 1");
		PausePanel.SetActive (false);
