...
public class ObjektifModul3 : MonoBehaviour {
	...
	void Start () {
		...
		audiosource.time = PlayerPrefs.GetFloat ("Objektif Modul 3");
	...
	public void chooseBookmark(){
		...
		PlayerPrefs.SetFloat ("Objektif Modul 3", audiosource.time);
	}

	public void chooseReplay(){

		PlayerPrefs.DeleteAll ();
		SceneManager.LoadScene ("Objektif Modul 3");
